  ...
  return (
    <header
      ...
      <div className=" relative z-10 px-5 md:text-start text-center w-full">
        <h2 className=" md:text-5xl text-4xl lg:text-7xl font-bebas text-white ">
          See What's Next
        </h2>
        <p className=" text-xl md:text-3xl text-white  italic">
          WATCH ANYWHERE. CANCEL ANYTIME
        </p>
        <button onClick={toWatchListHandler} className="bg-secondary text-white my-2 rounded-sm font-semibold px-6 py-2">
          To Watch List
        </button>
      </div>
    </header>
